              ...
              <form action="#" method="post">
                <div class="sc-list-head">
                  <div class="text-right a-spacing-top-micro">
                    <span class="a-color-secondary">Cijena</span>
                  </div>
                </div>
                <!-- Lista proizvoda-->
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-8">
                          ...
                          <div class="sc-action-links">
                            <select @change="onChangeQuantity($event, product)">
                              <option v-for="i in 10" :key="i" :value="i" :selected="checkQty(product.quantity, i)">Kol: &nbsp;{{i}}</option>
                            </select>
                            &nbsp;&nbsp;
                            <span>|</span>
                            &nbsp;
                            ...
                            <span class="a-size-small">
                              <a href="#" @click="$store.commit('removeProduct', product)">Obriši</a>
                            </span>
                            &nbsp;
                            &nbsp;
                          </div>
                        ...
                        <div class="col-sm-2 col-2 tr sm-txt-r">
                          ...
                          <p class="a-spacing-small">
                            ...
                            >{{product.price * product.quantity}} HRK</span>
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div class="text-right">
                  ...
                  <p class="a-spacing-none a-spacing-top-mini">
                    <span class="a-size-medium">Ukupno ({{getCartLength}} proizvoda)</span>
                    <span class="a-color-price a-text-bold">
                      <!-- Ukupna cijena košare -->
                      <span class="a-size-medium a-color-price">{{getCartTotalPrice}} HRK</span>
                    </span>
                  </p>
                </div>
              </form>
                  ...
                  <div class="a-spacing-mini">
                    <p class="a-spacing-none a-spacing-top-none">
                      ...
                      <span class="a-size-medium">
                        <span>Ukupno ({{getCartLength}} proizvoda):</span>
                        <span class="a-color-price a-text-bold">
                          <!-- Ukupna cijena košare  -->
                          <span class="a-size-medium a-color-price">{{getCartTotalPrice}} HRK</span>
                        </span>
                  ...
                  <div>
                    <span class="a-spacing-small a-button-primary a-button-icon">   
                      <span class="a-button-inner">
                        ...
                        <a href="#" class="a-button-text">Završi narudžbu</a>
                        </nuxt-link>
                      </span>
                    </span>
                  </div>
